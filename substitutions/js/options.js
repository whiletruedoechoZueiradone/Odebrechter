...
function addbutt(e, original, replacement) {
  ...
  next = next + 1;
  var newIn = '<div id="field' + next + '" class="row ginp"><div class="col-xs-6"> <input autocomplete="off" placeholder="Nome" name="origin" type="text" class="input form-control" value="' + original + '"></div><div class="col-xs-6"><div class="input-group"><input autocomplete="off" placeholder="Codinome" name="replace" type="text" class="input form-control"value="' + replacement + '">' + addBtn + ' </div>'
